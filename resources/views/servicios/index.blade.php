<x-app-layout><br>
    ...
    @section('content')
    <h1><b>Bienvenido a la página principal de Servicios</b></h1><br>
    <a href="{{route('servicios.create')}}">Solicitar Servicio</a>
    <ul>
       @foreach ($servicios as $servicio)
           <li>
               <a href="{{route('servicios.show', $servicio)}}">{{$servicio->name}}</a>
           </li>
       @endforeach
    </ul>

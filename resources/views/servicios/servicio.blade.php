<x-app-layout><br>
    ...
    <x-jet-authentication-card>
            ...
            <form action="{{route('servicios.store')}}" method="POST" >
                ...
                <x-jet-input id="nombre_completo" class="block mt-1 w-full" type="text" name="nombre_completo" value="{{old('nombre_completo')}}" required autofocus autocomplete="nombre_completo" />
                </div>
